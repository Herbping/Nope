...
(constraint (  iteB ( <=  (  plus2 ( twotimes x ) ( minus 3 ) )   ( plus3 z  ( minus ( twotimes y ) )  4    ) ) (  >=  ( eq1 x y z )  4 )  ( <= (eq1 x y z ) 4 ) ) )
(constraint (  iteB ( <=  (  plus2 ( twotimes x ) ( minus 3 ) )   ( plus3 z  ( minus ( twotimes y ) )  4    ) ) (  >=  ( eq1 x y z )  y )  ( <= (eq1 x y z ) y ) ) )
(constraint (  iteB ( <=  (  plus2 ( twotimes x ) ( minus 3 ) )   ( plus3 z  ( minus ( twotimes y ) )  4    ) ) (  >=  ( eq1 x y z )  z )  ( <= (eq1 x y z ) z ) ) )
